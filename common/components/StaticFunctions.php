...
//        $result []= Yii::$app->params['main_lang'];
    ...
    public static function getSettings( $id = '' )
    {
        ...
        if( $id )
        {
            ...
            {
                return Settings::findOne( $id )->getLang('val');
            }
    ...
    public static function getImage($model, $type, $attribute){
        ...
        if($type == 'resource' || $type == 'news'){
            if(Yii::$app->language == Yii::$app->params['main_language']){
                ...
                if($model->getLang($attribute) && file_exists(Yii::getAlias('@frontend') . '/web' . Yii::$app->params['uploads_url'] . $type . '/' . $model->id . '/m_' . $model->getLang($attribute))){
                    return Yii::$app->params['frontend'] . Yii::$app->params['uploads_url'] . $type . '/' . $model->id . '/l_' . $model->getLang($attribute);
                }
            }
        }else{
            if($model->$attribute && file_exists(Yii::getAlias('@frontend') . '/web' . Yii::$app->params['uploads_url'] . $type . '/' . $model->id . '/m_' . $model->$attribute)){
